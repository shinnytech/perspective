...
export declare type PerspectiveViewerConfig = perspective.ViewConfig & {
    plugin?: string;
    settings?: boolean;
    plugin_config?: any;
};
 ...
 * @noInheritDoc
 */
export declare class HTMLPerspectiveViewerElement extends HTMLElement {
    private instance;
    /**
     ...
     * ```
     */
    setAutoSize(autosize?: boolean): Promise<void>;
    /**
     ...
     */
    unsafe_get_model(): Promise<number>;
    /**
